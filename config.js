...
const LANG_STRINGS = {
  id: {
    ...
    btn_simpan_binid: "Simpan Bin ID",
    btn_cari_binid: "Cari Bin ID Otomatis",
    binid_hint: 'Cara cari Bin ID: (1) Klik "Cari Bin ID Otomatis" di bawah. (2) Atau biarkan kosong lalu ketik satu reminder & tunggu tersimpan — ID baru otomatis muncul di sini. (3) Atau manual: login jsonbin.io, buka "My Bins", klik bin bernama viiib-reminder, ID-nya ada di URL. ID ini juga sebaiknya ditaruh admin di file config.js supaya semua device otomatis nyambung tanpa isi manual.',
    btn_keluar: "Keluar",
  ...
  betawi: {
    ...
    btn_simpan_binid: "Simpen Bin ID",
    btn_cari_binid: "Cariin Bin ID Otomatis",
    binid_hint: 'Cara nyariin Bin ID: (1) Pencet "Cariin Bin ID Otomatis" di bawah. (2) Ato biarin kosong terus ketik satu reminder, tunggu ke-simpen — ID baru bakal muncul otomatis di sini. (3) Ato manual: login jsonbin.io, buka "My Bins", pencet bin yang namenye viiib-reminder, ID-nye ada di URL-nye. ID ini enakan ditaro ame admin di file config.js biar semua device langsung nyambung, gak usah isi manual satu-satu.',
    btn_keluar: "Keluar",
  ...
  en: {
    ...
    btn_simpan_binid: "Save Bin ID",
    btn_cari_binid: "Auto-Find Bin ID",
    binid_hint: 'How to find the Bin ID: (1) Click "Auto-Find Bin ID" below. (2) Or leave it blank, type a reminder, and wait for it to save — a new ID appears here automatically. (3) Or manually: log in to jsonbin.io, open "My Bins", click the bin named viiib-reminder, the ID is in the URL. It\'s best if the admin also puts this ID in config.js so every device connects automatically without manual entry.',
    btn_keluar: "Log Out",
  ...
  su: {
    ...
    binid_hint: 'Cara néangan Bin ID: (1) Pencét "Panggihan Bin ID Otomatis" di handap. (2) Atawa biarkeun kosong, tulis reminder, antosan kasimpen — ID anyar muncul otomatis. (3) Atawa manual: login ka jsonbin.io, buka "My Bins", pencét bin nu ngaranna viiib-reminder, ID-na aya dina URL. Alusna ID ieu ogé ditulis ku admin dina config.js supaya sadaya device otomatis nyambung.',
    btn_keluar: "Kaluar",
