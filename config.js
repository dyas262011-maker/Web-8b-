...
const LANG_STRINGS = {
  id: {
    ...
    btn_tambah_nama: "Tambah Nama",
    label_kas_belum_ada_nama: "Belum ada nama. Tambahkan nama siswa di atas untuk mulai mencatat kas.",
    label_kas_data_aman: "Nama yang sudah pernah kamu tambahkan tetap tersimpan otomatis dari server -- tidak hilang meski tab ini sempat disembunyikan.",
