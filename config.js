...
const LANG_STRINGS = {
  id: {
    ...
    label_kas_member_hint: 'Nama di sini bebas bayar kas sampai tanggal yang ditentukan. Tier "Mahkota" untuk membership terbesar, "Berlian" untuk sisanya. Tampil otomatis di halaman Pengumuman.',
    btn_tambah_member: "Tambah Member",
    label_member_kas: "Member Kas",
    label_kas_member_kosong: "Belum ada member kas.",
    label_berlaku_sampai: "Berlaku sampai",
    kas_tier_mahkota: "Mahkota",
    kas_tier_berlian: "Berlian",
